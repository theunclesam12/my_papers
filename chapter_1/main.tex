...
\IEEEPARstart{T}{his} paper addresses [short problem description]. Motivation: explain why the problem matters in practice and research. Provide a succinct statement of challenges (e.g., occlusion, domain shift, limited annotations).
...
\begin{itemize}
  \item A short list (3--5 items) of the main contributions (novel model components, datasets, benchmarks, analysis).
  \item New loss / architecture / training strategy and empirical gains on standard benchmarks.
  \item Release of code / dataset (if applicable).
\end{itemize}
...
% Short paragraph and key citations.

\subsection{Deep learning methods}
% Architectures and representative recent works.
...
\label{sec:method}
\subsection{Overview}
% Pipeline figure (Figure~1) and algorithmic summary.
